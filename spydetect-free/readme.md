...
* This program shows no version number. File details of the executable show version 1.0.0.0 on the previous and current version even though it's been updated.
