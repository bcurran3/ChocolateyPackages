#http://files2.majorgeeks.com/86c2cc4137ba0c9a8392cad3f9837980390245c3/multimedia/ADVANCED_Codecs_v789.exe
$toolsDir       = "$(Split-Path -parent $MyInvocation.MyCommand.Definition)"
$packageName    = 'advanced-codecs' 
$url            = "$toolsDir\ADVANCED_Codecs_v789.exe"
$checksum       = '14BE3F327B93B94D0AC5788894FAAEDF9525497C2574B885A754BDD6E12E8F55'
$installerType  = 'EXE'
$silentArgs     = '/S /v/qn'
