...
* This package will NOT upgrade or reinstall well as it uninstalls the previous version first and the package is not currently scripted to handle that. Not compatible with readynas-remote package as ReadyCLOUD will uninstall ReadyNAS Remote and this package is not scripted to handle that situation.
