...
Write-Host "From Windows, double click choco-package-list-backup-manual.bat in \ProgramData\chocolatey\lib\choco-package-list-backup\tools" -foreground "magenta" –backgroundcolor "blue"