...
$packageName= 'digital-video-repair' # arbitrary name for the package, used in messages
...
$packageArgs = @{
  ...
  softwareName  = 'digital-video-repair*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
