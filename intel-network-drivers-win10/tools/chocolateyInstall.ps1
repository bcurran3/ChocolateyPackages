...
# Drivers
$url            = "https://downloadmirror.intel.com/$IntelPackageNumber/Wired_driver_"+$TodaysVersion+"_32.zip"
...
$packageArgs = @{
  ...
  FileFullPath   = "$unzipLocation\Wired_driver_"+$TodaysVersion+"_32.exe"
  FileFullPath64 = "$unzipLocation\Wired_driver_"+$TodaysVersion+"_x64.exe"
}
...
# PROSet software
$url            = "https://downloadmirror.intel.com/$IntelPackageNumber/Wired_PROSet_"+$TodaysVersion+"_32.zip"
...
$packageArgs = @{
  packageName    = $packageName
  Destination    = $unzipLocation
  FileFullPath   = "$unzipLocation\Wired_PROSet_"+$TodaysVersion+"_32.exe"
  FileFullPath64 = "$unzipLocation\Wired_PROSet_"+$TodaysVersion+"_x64.exe"
}
