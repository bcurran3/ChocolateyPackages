...
* This will NOT upgrade correctly - you will HAVE TO manually interact with the upgrade. Steps to update the AutoHotKey script to handle this are being worked on.
