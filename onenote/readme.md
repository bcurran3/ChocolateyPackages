...
* If you have Office 32-bit installed and install the 64-bit version of OneNote, you will be prompted and it will break the silent install. Use --x86 or --forcex86 to force 32 bit on 64 bit systems.
* Uninstall is not silent, use the Control Panel.
